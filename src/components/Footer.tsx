        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li><Link href="/es/ciudades" className="hover:text-white transition-colors">{locale === "es" ? "Ciudades" : "Cities"}</Link></li>
              <li><Link href={`/${locale}/lesiones`} className="hover:text-white transition-colors">{dict.nav.injuries}</Link></li>
              <li><Link href={`/${locale}/guias`} className="hover:text-white transition-colors">{dict.nav.guides}</Link></li>
