...
Texas usa un sistema de **negligencia comparativa modificada con un umbral del 51%**, establecido en la Sección 33.001 del Código de Prácticas Civiles y Remedios de Texas. Esto significa:

- Si tienes **50% o menos** de la culpa, puedes recuperar compensación (reducida por tu porcentaje de culpa)
- Si tienes **51% o más** de la culpa, no puedes recuperar nada

Por ejemplo: si tus daños totales son $100,000 y el jurado determina que tuviste un 20% de la culpa, recibirías $80,000. Pero si tuviste un 51% de la culpa, recibirías $0.

Esta regla hace que la documentación del accidente sea crítica. Quien tuvo la culpa — y en qué porcentaje — puede significar la diferencia entre recibir compensación completa o no recibir nada.

## Estatuto de limitaciones en Texas

El estatuto de limitaciones establece cuánto tiempo tienes para presentar una demanda después de un accidente. En Texas, los plazos son:
...
- **Vehículos gubernamentales**: si el accidente involucró un vehículo del gobierno (estatal, municipal, federal), debes presentar un aviso formal dentro de **6 meses** bajo la Ley de Reclamos por Agravios de Texas (Texas Tort Claims Act). Este plazo es mucho más corto y se aplica estrictamente.
...
- **$30,000** por persona en responsabilidad por lesiones corporales
- **$60,000** por accidente en responsabilidad por lesiones corporales
- **$25,000** en responsabilidad por daños a la propiedad

Esto es significativamente más alto que los mínimos de Florida ($10,000 PIP + $10,000 PDL), pero aún puede ser insuficiente para lesiones serias. Si tus gastos médicos alcanzan $100,000 y el otro conductor solo tiene la cobertura mínima, te quedarán $70,000 sin cubrir.

Texas también permite la cobertura de **motorista sin seguro/con seguro insuficiente (UM/UIM)**, que te protege si el otro conductor no tiene seguro o tiene seguro insuficiente. Dado que Texas tiene una tasa de conductores sin seguro de aproximadamente el 14% (según el Insurance Research Council), esta cobertura es altamente recomendable.
